...
The json (written by soul_scene.py) holds, per device, the two projected end points of its diameter
(normalised image coordinates) and the label. Thin sans labels, thin dimension line with end ticks.
"""
import json
import os
import sys
